...
import { CardActionArea, Icon} from '@material-ui/core';
...
function Bookcard(props) {
	...
	return (
  	<Card sx={{ width: 135, height: 400, margin: props.margin}}>
      ...
      <CardContent sx={{paddingBottom: "0px"}}>
        ...
        {props.needPrice &&
          <Typography variant="body2" color="text.secondary">
            ${parseFloat(props.price).toFixed(2)|| "Price"}
          </Typography>
        }
      </CardContent>
      { props.needShelfCartBtns &&
        <CardActions>
            <IconButton color="primary" aria-label="add to shelf"><AddBoxOutlinedIcon /></IconButton>
            <IconButton color="primary" aria-label="add to cart"><ShoppingCartOutlinedIcon /></IconButton>
